...
Task.create(issue_id: 2, title: '生産技術と調整',  start: '2020-10-19 08:00:00', time: '02:00:00')
Task.create(issue_id: 3, title: '得意先と調整',    start: '2020-10-19 010:00:00', time: '01:00:00')
Task.create(issue_id: 1, title: '作業性検討',     start: '2020-10-19 11:00:00', time: '04:00:00')
Task.create(issue_id: 1, title: 'データ作成',     start: '2020-10-19 15:00:00', time: '01:30:00')
Task.create(issue_id: 1, title: '生産技術と調整',  start: '2020-10-19 16:30:00', time: '02:30:00')
...
Task.create(issue_id: 1, title: 'データ作成', start: '2020-10-20 12:30:00', time: '00:30:00')
Task.create(issue_id: 3, title: '技術検討依頼書作成', start: '2020-10-20 13:00:00', time: '04:00:00')
Task.create(issue_id: 1, title: 'データ作成', start: '2020-10-20 17:00:00', time: '01:00:00')
Task.create(issue_id: 2, title: '見積依頼書作成', start: '2020-10-21 07:00:00', time: '03:00:00')
Task.create(issue_id: 3, title: 'データ作成', start: '2020-10-21 10:00:00', time: '02:30:00')
Task.create(issue_id: 1, title: '技術検討依頼書作成', start: '2020-10-21 12:30:00', time: '04:00:00')
Task.create(issue_id: 1, title: 'データ作成', start: '2020-10-21 16:30:00', time: '00:30:00')
Task.create(issue_id: 2, title: '可否検討', start: '2020-10-21 17:00:00', time: '03:00:00')